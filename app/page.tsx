    ...
    <main className="min-h-screen bg-cream">
      {phase === Phase.FIRST_VISIT && (
        <section className="flex min-h-screen flex-col items-center justify-center gap-4 p-8">
          <p className="font-heading text-deep-rose text-2xl">Phase 1 — First Visit</p>
          <p className="font-body text-sage text-lg">Name + city form goes here</p>
        </section>
      )}
      ...
      {phase === Phase.RETURN_VISIT && (
        <section className="flex min-h-screen flex-col items-center justify-center gap-4 p-8">
          <p className="font-heading text-deep-rose text-2xl">
            Phase 2 — Welcome back{guestName ? `, ${guestName}` : ""}!
          </p>
          <p className="font-body text-sage text-lg">Countdown hero + full site goes here</p>
        </section>
      )}

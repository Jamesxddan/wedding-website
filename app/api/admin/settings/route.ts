...
export async function POST(req: NextRequest) {
  ...
  const allowed = ["phase_override", "youtube_live_url", "youtube_ceremony_url", "youtube_reception_url", "youtube_comment_video_id", "announcement", "site_content", "highlights_video_url", "post_wedding_photos_url", "post_wedding_videos_url", "wedding_folder_id", "slideshow_mobile_ids", "slideshow_desktop_ids", "chatbot_enabled", "chatbot_faq", "chatbot_model"];

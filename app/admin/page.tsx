        ...
        <>
          ...
          {!loading && (
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", background: "#fff", minWidth: 640 }}>
              <thead>
                <tr>{["Name", "City", "Device", "Devices", "First visit", "Last seen", "Inv. seen", "📷", "Sub-Admin", ...(isSuper ? [""] : [])].map((h) => <th key={h} style={th}>{h}</th>)}</tr>
              </thead>
              <tbody>
                {guests.map((g) => {
                      ...
                      <tr key={g.id}>
                        ...
                        <td style={td}>
                          <button
                            ...
                            title="Sub-admins get the preview gear icon on the main site (screens & error states) — this does not grant admin panel access."
                          ...
                          >
                            {g.is_owner ? "Sub-Admin ✓" : "Set sub-admin"}
                          </button>
                        </td>
                        {isSuper && (
                          <td style={td}>

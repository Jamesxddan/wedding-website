...
export default function PostWeddingHero({ guestName }: Props) {
  ...
  const highlightsId = highlightsUrl ? extractYoutubeId(highlightsUrl) : null;
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6" style={{ maxWidth: 580 }}>
          ...
          {/* Drive links */}
          {(photosUrl || videosUrl) && (
            <div style={{ ...fade(750), display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
              {photosUrl && (
                <a
                  href={photosUrl}
                  target="_blank"
                  ...
                  style={{
                    ...
                    background: `linear-gradient(135deg, ${RA(0.9)}, rgba(140,50,75,0.85))`,

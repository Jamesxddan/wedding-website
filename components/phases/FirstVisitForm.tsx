  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5 w-full max-w-md">
      <div className="flex flex-col gap-1.5">
        <label htmlFor="guest-name" className="font-heading text-[12px] text-deep-rose/80 tracking-[0.3em] uppercase">
          Your Name
        </label>
        <input
          id="guest-name"
      ...
      <div className="flex flex-col gap-1.5 relative" ref={dropdownRef}>
        <label htmlFor="guest-city" className="font-heading text-[12px] text-deep-rose/80 tracking-[0.3em] uppercase">
          Your City
        </label>
